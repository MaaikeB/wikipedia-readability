...
def _get_category_page_ids(category_title, articles_limit):
    ...
    try:
        category_page_list = response_data['query']['categorymembers']
        page_ids = [category_page['pageid'] for category_page in category_page_list]
...
def _get_page_extracts(page_ids, page_intro, number_of_characters):
    ...
    # todo: try catch
    page_data = response_data['query']['pages']
